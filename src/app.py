...
activities = {
    ...
    "Basketball Team": {
        "description": "Competitive basketball team for athletic students",
    ...
    "Music Performance": {
        "description": "Join the school orchestra and perform classical pieces",
...
def unregister_participant(activity_name: str, email: str):
    ...
    # Validate participant exists in the activity roster
